...
const routes = [
    ...
    {
        path: '/Newaricle', name: 'Newaricle', component: () => import('../views/static/Newaricle.vue') //懒加载 
    },
    {
        path: '/Newaricle1', name: 'Newaricle1', component: () => import('../views/static/Newaricle1.vue') //懒加载 
    },
    {
